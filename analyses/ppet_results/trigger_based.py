...
path = '/Users/winnwu/projects/Hu_Lab/COT_project/generate/mimiciv/tokenarray/'
FPR_max = 0.15

# read in the data
case = np.load(path + 'case_toolbox_input_' + str(FPR_max) + '_sparse.npy', allow_pickle=True)
control = np.load(path + 'control_toolbox_input_' + str(FPR_max) + '_sparse.npy', allow_pickle=True)
