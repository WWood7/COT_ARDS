...
test_path = generate_path + 'mimiciv/tokenarray/'
# set the store path
store_path = generate_path + 'XGB_results/mimiciv'
...
# case
test_case_hitarray = np.load(test_path + 'case_HitArray_dict_' + str(FPR_max) +
...
# control
test_control_hitarray = np.load(test_path + 'control_HitArray_dict_' + str(FPR_max) +
                                '_sparse.npy', allow_pickle=True).item()
