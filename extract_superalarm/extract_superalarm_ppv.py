...
combine_and_save_as_json(top_pattern_list, top_source_list, ppv_store_path,
                         top_ppv_list, top_tpr_list, 1)
combine_and_save_as_json(bottom_pattern_list, bottom_source_list, ppv_store_path,
